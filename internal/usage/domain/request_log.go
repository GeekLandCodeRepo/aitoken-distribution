...
type RequestLogRepository interface {
	...
	GetTokenTrend(granularity string, date time.Time, days int, loc *time.Location) ([]*TokenTrendPoint, error)
	GetUserTokenTrend(userID string, granularity string, date time.Time, days int, loc *time.Location) ([]*TokenTrendPoint, error)
